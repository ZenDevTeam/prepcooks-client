...
<b-modal id="modalPopover" title="Add new company" ok-only size="xl" v-bind:hide-footer="true">
    <div class="companyForm">
        ...
        <b-form-group label="Logo URL">
            <b-form-input v-model="form.logoURL" type="text" placeholder="Please enter the link to your logo"></b-form-input>
        </b-form-group>
        ...
        <b-row>
            ...
            <b-col>
                <b-form-group label="Extra Protein:">
                    <b-form-radio v-model="form.extraProtein" name="extraProtein-radios" value="True">Yes</b-form-radio>
                    <b-form-radio v-model="form.extraProtein" name="extraProtein-radoos" value="False">No</b-form-radio>
                </b-form-group>
            </b-col>
            <b-col>
